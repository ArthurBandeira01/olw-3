    ...
    <div class="bg-tertiary-900">
        ...
        <div class="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 gap-x-16 lg:px-8 lg:pt-16">
            <section aria-labelledby="summary-heading"
                class="bg-tertiary-800 py-12 md:px-10 lg:col-start-2 lg:pb-24 lg:pt-0
                    lg:row-start-1 lg:mx-auto lg:max-w-lg lg:bg-transparent lg:px-0">
                <div class="mx-auto max-w-1xl px-4 lg:max-w-none lg:px-0">
                    <dl>
                        <div class="text-lg font-medium text-primary-200">Resumo</div>
                    </dl>
                ...
                <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                    <div class="mt-1">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="mt-1">
                                <x-text-input type="email" id="email-address" autocomplete="email" placeholder="Digite seu e-mail..."/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-6 grid grid-cols-3 gap-x-4 gap-y-6 sm:grid-cols-4">
                            <div class="col-span-3 sm:col-span-4">
                                ...
                                <div class="mt-1">
                                    <x-text-input type="text" id="card-number" placeholder="N° cartão"/>
                                </div>
                            </div>

                            <div class="col-span-2 sm:col-span-3">
                                <x-input-label for="expiration-date" value="Vencimento" />
                                <div class="mt-1">
                                    <x-text-input type="text" id="expiration-date" placeholder="MM / AA"/>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-text-input type="text" id="cvc" placeholder="CVC"/>
                                </div>
                            </div>
                        </div>
                    </div>
